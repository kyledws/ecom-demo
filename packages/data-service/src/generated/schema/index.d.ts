...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  contentForOne: Resolver<Maybe<ResolversTypes['Content']>, ParentType, ContextType, RequireFields<QueryContentForOneArgs, 'id'>>;
  contentForMany: Resolver<ReadonlyArray<ResolversTypes['Content']>, ParentType, ContextType, RequireFields<QueryContentForManyArgs, 'id'>>;
  page: Resolver<Maybe<ResolversTypes['Page']>, ParentType, ContextType, RequireFields<QueryPageArgs, 'site' | 'fullSlug'>>;
  departuresForOne: Resolver<ReadonlyArray<ResolversTypes['Departure']>, ParentType, ContextType, RequireFields<QueryDeparturesForOneArgs, 'tourCodeYear'>>;
  departuresForMany: Resolver<ReadonlyArray<ResolversTypes['Departure']>, ParentType, ContextType, RequireFields<QueryDeparturesForManyArgs, 'tourCodeYear'>>;
  excursion: Resolver<Maybe<ResolversTypes['Excursion']>, ParentType, ContextType, RequireFields<QueryExcursionArgs, 'itemMatchCode'>>;
  excursions: Resolver<ReadonlyArray<ResolversTypes['Excursion']>, ParentType, ContextType, RequireFields<QueryExcursionsArgs, 'itemMatchCodes'>>;
  tour: Resolver<Maybe<ResolversTypes['Tour']>, ParentType, ContextType, RequireFields<QueryTourArgs, 'tourCodeYear'>>;
  tours: Resolver<ReadonlyArray<ResolversTypes['Tour']>, ParentType, ContextType, RequireFields<QueryToursArgs, 'tourCodeYears'>>;
};
...
export type PageResolvers<ContextType = any, ParentType extends ResolversParentTypes['Page'] = ResolversParentTypes['Page']> = {
  __resolveType: TypeResolveFn<'ToursLandingPage' | 'ToursTourPage', ParentType, ContextType>;
...
export type ToursLandingPageResolvers<ContextType = any, ParentType extends ResolversParentTypes['ToursLandingPage'] = ResolversParentTypes['ToursLandingPage']> = {
  content: Resolver<ReadonlyArray<ResolversTypes['Content']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType>;
};

export type ToursTourPageResolvers<ContextType = any, ParentType extends ResolversParentTypes['ToursTourPage'] = ResolversParentTypes['ToursTourPage']> = {
  contentSlots: Resolver<Maybe<ResolversTypes['ToursTourPageContentSlots']>, ParentType, ContextType>;
...
export type ToursTourPageContentSlotsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ToursTourPageContentSlots'] = ResolversParentTypes['ToursTourPageContentSlots']> = {
  aboveDescription: Resolver<ReadonlyArray<ResolversTypes['Content']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType>;
};

export type DepartureResolvers<ContextType = any, ParentType extends ResolversParentTypes['Departure'] = ResolversParentTypes['Departure']> = {
...
export type ExcursionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Excursion'] = ResolversParentTypes['Excursion']> = {
...
export type ItineraryDayResolvers<ContextType = any, ParentType extends ResolversParentTypes['ItineraryDay'] = ResolversParentTypes['ItineraryDay']> = {
  description: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type TourResolvers<ContextType = any, ParentType extends ResolversParentTypes['Tour'] = ResolversParentTypes['Tour']> = {
  departures: Resolver<ReadonlyArray<ResolversTypes['Departure']>, ParentType, ContextType, RequireFields<TourDeparturesArgs, never>>;
  description: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
